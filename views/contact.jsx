    ...
    <div className="Contact">
      <section className={styles.section}>
        <Image
          ...
          width={600}
          height={800}
          src={`https://maps.geoapify.com/v1/staticmap?style=positron-blue&width=600&height=800&center=lonlat:-122.81638,38.547133&zoom=12.4&pitch=33&marker=lonlat:-122.81436621391315,38.54646663084179;color:%2342445a;size:medium&apiKey=${process.env.NEXT_PUBLIC_SECRET}`}
          alt="map"
        />
